...
import com.camcory.bluez.ThemerConstants.APK_SIGNATURE_PRODUCTION
import com.camcory.bluez.ThemerConstants.BASE_64_LICENSE_KEY
import com.camcory.bluez.ThemerConstants.ENABLE_KNOWN_THIRD_PARTY_THEME_MANAGERS
import com.camcory.bluez.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL
import com.camcory.bluez.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL
import com.camcory.bluez.ThemerConstants.ENFORCE_INTERNET_CHECK
import com.camcory.bluez.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION
import com.camcory.bluez.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION
import com.camcory.bluez.ThemerConstants.PIRACY_CHECK
import com.camcory.bluez.ThemerConstants.SUBSTRATUM_FILTER_CHECK
import com.camcory.bluez.ThemerConstants.THEME_READY_GOOGLE_APPS
import com.camcory.bluez.internal.SystemInformation.SUBSTRATUM_PACKAGE_NAME
import com.camcory.bluez.internal.SystemInformation.checkNetworkConnection
import com.camcory.bluez.internal.SystemInformation.getSelfSignature
import com.camcory.bluez.internal.SystemInformation.getSelfVerifiedIntentResponse
import com.camcory.bluez.internal.SystemInformation.getSelfVerifiedPirateTools
import com.camcory.bluez.internal.SystemInformation.getSelfVerifiedThemeEngines
import com.camcory.bluez.internal.SystemInformation.getSubstratumUpdatedResponse
import com.camcory.bluez.internal.SystemInformation.hasOtherThemeSystem
import com.camcory.bluez.internal.SystemInformation.isPackageInstalled
import com.camcory.bluez.internal.TBOConstants.EXTRA_PACKAGE_NAMES
import com.camcory.bluez.internal.TBOConstants.THEME_READY_PACKAGES
import java.io.File
import java.util.*
